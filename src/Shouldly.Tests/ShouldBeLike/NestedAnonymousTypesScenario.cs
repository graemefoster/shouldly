...
{
    public class NestedAnonymousTypesScenario : ShouldlyShouldTestScenario
    {
        protected override void ShouldPass()
        {
            new { Person = new { Name = "Graeme" } }.ShouldBeLike(new { Person = new { Name = "Graeme" } });
        }

        protected override void ShouldThrowAWobbly()
        {
            new { Person = new { Name = "Graeme" } }.ShouldBeLike(new { Person = new { Name = "Other" } });
        }
